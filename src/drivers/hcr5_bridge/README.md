...
| `include/hcr5_bridge/hcr_system_interface.hpp` · `src/hcr_system_interface.cpp` | **ros2_control 하드웨어 플러그인** (§0) — MoveIt2 실행 경로용 |
...
[`src/moveit2/README.md`](../../moveit2/README.md) 가 원본이고, 여기서는 **들어가는 법만** 든다.
...
- **실기 전환은 인자다** — `hardware_plugin:=hcr5_bridge/HcrSystemInterface rw_rate:=30 is_async:=true`.
