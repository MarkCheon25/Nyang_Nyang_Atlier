...
#ifndef HCR5_BRIDGE__MQTT_CLIENT_HPP_
#define HCR5_BRIDGE__MQTT_CLIENT_HPP_
...
// 컴파일러가 hcr5_bridge::X 를 새로 선언해버려 libmosquitto 의 타입과 어긋난다.
struct mosquitto;
...
#endif  // HCR5_BRIDGE__MQTT_CLIENT_HPP_
