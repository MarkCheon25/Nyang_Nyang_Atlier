...
| 비전 좌표 수용 | ✅ | 부위 5 개 수신 → letterbox 변환. 계산값이 비전 원본 공식과 소수점까지 일치 |
...
**메시지 타입 해시가 우리 것과 같은지 대조 부탁**

`vision_interfaces` 를 moveit2 쪽에 미러로 복제해 두었다(원본이 moveit2 워크스페이스에
보이지 않아서). 필드 이름·타입·순서 중 하나라도 다르면 **토픽은 보이는데 메시지가
0 개** 들어오고 에러가 안 난다.
...
우리 기준값: `RIHS01_d8c0b1c8ffdbe600b7b59775cc2460b82c96be241faf49fea80c7393e77506d7`
