...
//
// 계약은 상위 문서가 소유한다 —
//   src/drivers/hcr_comm/ros2_control_hw_interface/중간결과물.md
...
#ifndef HCR_BRIDGE__HCR_SYSTEM_INTERFACE_HPP_
#define HCR_BRIDGE__HCR_SYSTEM_INTERFACE_HPP_
...
#endif  // HCR_BRIDGE__HCR_SYSTEM_INTERFACE_HPP_
