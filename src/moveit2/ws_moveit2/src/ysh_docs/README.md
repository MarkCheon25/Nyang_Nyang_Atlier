...
| 날짜 | 무엇 | 상세 | 요약 | 실행법 |
|---|---|---|---|---|
| **260809** | 기구학 정본 교정(43mm) · 비전 좌표로 고양이 그리기 | [상세](./260809_상세.md) | [요약](./260809_요약.md) | [실행법](./260809_실행법.md) |
| 260808 | HCR-5 신규 구축 · 예제 3종 · 자취 시각화 | 이 문서 (§1~§4) | [요약](../../../docs/ysh_HCR5_ros2_control_요약.md) | 이 문서 §2 |

> 이 `README.md` 는 **워크스페이스 전체 정리**(무엇이 있고 어떻게 돌리는가)이고,
> `2608xx_*.md` 는 **그날 한 작업의 기록**이다. 날짜별 문서가 더 최신이다.

![펜 자취](./frist_pic.png)

*260809 결과 — 비전이 뽑은 고양이 윤곽선 70점을 mock 로봇이 그린 자취. 달성률 100%.*
